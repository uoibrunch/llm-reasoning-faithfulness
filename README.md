You are absolutely right, my apologies. When the text renders directly in the chat, it can be difficult to copy the raw formatting tags.

Here is the exact README in a raw Markdown code block so you can easily copy and paste it into your repository. *(Note: I have adjusted the mathematical formulas to standard plain-text formatting to ensure they copy cleanly, as some Markdown parsers handle equation delimiters differently).*
...
### 1. Perturbation & Explanation Consistency Score (ECS)
